...
@test "assign 9 test 1" {
    run bash -c './assign9.out <<EOF
2
101
Laptop
50000.0
...
0.01
EOF'
    [[ "$output" == *"The total value is 1000000.000000"* ]] || [[ "$output" == *"The total value is 1000000.010000"* ]] || [[ "$output" == *"The total value is 1000000.000000"* ]]
}

@test "assign 9 test 8" {
    run bash -c './assign9.out <<EOF
3
11
X
